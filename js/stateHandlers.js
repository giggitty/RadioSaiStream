...
var stateHandlers = {
    startModeIntentHandlers : Alexa.CreateStateHandler(constants.states.START_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            //** AD-Comment this.attributes['shuffle'] = false;
            this.attributes['playbackIndexChanged'] = true;
            //  Change state to START_MODE
            this.handler.state = constants.states.START_MODE;

            var message = 'Welcome to the Radio Sai Skill. You can say, play Bhajan or Discourse Streams';
            var reprompt = 'You can say, play Radio Sai to begin.';
        ...
        'AMAZON.StopIntent' : function () {
            var message = 'Sai Ram! Have a great day!';
        ...
        'Unhandled' : function () {
            var message = 'Sorry, I could not understand. Please say, play Radio Sai to begin.';
            this.response.speak(message).listen(message);
            this.emit(':responseReady');
        }
    }),
    playModeIntentHandlers : Alexa.CreateStateHandler(constants.states.PLAY_MODE, {
        ...
        'LaunchRequest' : function () {
             ...
             *  Else :
             *      Ask user if he/she wants to resume the last track.
            ...
            if (this.attributes['playbackFinished']) {
                this.handler.state = constants.states.START_MODE;
                message = 'Welcome to the Radio Sai Skill. You can say, play Bhajan or Discourse Streams';
                reprompt = 'You can say, play Radio Sai to begin.';
            } else {
                this.handler.state = constants.states.RESUME_DECISION_MODE;
                message = 'You were listening to the ' + audioData[this.attributes['playOrder'][this.attributes['index']]].title +
        ...
        //** AD-Comment 'AMAZON.ShuffleOnIntent' : function () { controller.shuffleOn.call(this) },
        //** AD-Comment 'AMAZON.ShuffleOffIntent' : function () { controller.shuffleOff.call(this) },
        //** AD-Comment 'AMAZON.StartOverIntent' : function () { controller.startOver.call(this) },
        'AMAZON.HelpIntent' : function () {
            // This will called while audio is playing and a user says "ask <invocation_name> for help"
            var message = 'You are listening to the Radio Sai Stream. You can say, Next or Previous to navigate through different streams. ' +
        ...
        'Unhandled' : function () {
            var message = 'Sorry, I could not understand. You can say, Next or Previous to navigate through different streams.';
            this.response.speak(message).listen(message);
            this.emit(':responseReady');
        }
    }),
    ...
    resumeDecisionModeIntentHandlers : Alexa.CreateStateHandler(constants.states.RESUME_DECISION_MODE, {
         ...
         */
        'LaunchRequest' : function () {
            var message = 'You were listening to the' + audioData[this.attributes['playOrder'][this.attributes['index']]].title +
                ' Would you like to resume?';
...
var controller = function () {
    return {
        play: function () {
            ...
            //** AD-Comment var offsetInMilliseconds = this.attributes['offsetInMilliseconds'];
